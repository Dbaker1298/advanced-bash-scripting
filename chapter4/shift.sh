...
#  Name this script something like shift.sh,
#+ and invoke it with some parameters.
#+ For example:
#               shift.sh a b c def 83 barndoor
...
#  But, what what happens to the "used-up" parameters?
echo "$2"
#  Nothing echoes!
#  When $2 shifts into $1  (and there is no $3 to shift to $2)
