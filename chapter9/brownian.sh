...
#+ This is collowquially known as the "Drunkard's WAlk."
...
#  To what extent does this affect the accuracy fo the simulation?
#  ----------------------------------------------------------------
...
#  Exercises:
#  ----------
#  1)  Show the results in a veritcal bar graph, or as an alternative,
#+     a scattergram.
